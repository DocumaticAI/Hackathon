...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(result)
    const neutral = "http://cdn.shopify.com/s/files/1/1061/1924/products/Neutral_Face_Emoji_grande.png?v=1571606037"
    const positive = "https://cdn.shopify.com/s/files/1/1061/1924/products/Smiling_Face_Emoji_large.png?v=1571606036"
    const negative = "https://cdn.shopify.com/s/files/1/1061/1924/products/Sad_Face_Emoji_large.png?v=1571606037"
    ...
    if(result["output"].toString().toLowerCase() == "neutral" ){
        img = neutral
        color = 'GRAY'
    }else if(result["output"].toString().toLowerCase() == "negative" || result["output"].toString().toLowerCase() == "verynegative"){
        img = negative
        color = 'RED'
    }else if(result["output"].toString().toLowerCase() == "positive" || result["output"].toString().toLowerCase() == "verypositive"){
        img = positive
        color = 'GREEN'
    }
