...
const Header = (props) => {
  ...
  const fetchData = async () => {
    if (shouldRequestStats()) {
      const response = await axios.get('https://api.github.com/repos/krypton-hackathon0/hackathon');
  ...
  return (
    <div className="shadow flex items-center justify-center flex-col mb-2 py-2">
      ...
      <div className="flex justify-center items-center">
        <a href="https://github.com/krypton-hackathon0/hackathon" aria-label="Star krypton-hackathon0/hackathon on GitHub" target="blank" className="mr-2">
        ...
        <a href="https://github.com/krypton-hackathon0/hackathon/fork" aria-label="Fork krypton-hackathon0/hackathon on GitHub" target="blank">
          <div className="text-xxs sm:text-sm border-2 border-solid border-gray-900 bg-gray-100 flex items-center justify-center py-1 px-2">
