  ...
  <>
    ...
    <div className="flex flex-col sm:flex-row items-start justify-between">
      ...
      <div className="w-full sm:w-1/3 flex flex-col justify-center items-center">
        ...
        {/* Ko-Fi */}
        <a href="https://ko-fi.com/" className="flex items-center justify-evenly bg-red-500 text-white py-2 px-4 my-2" target="_blank" rel="noreferrer">
          <img className="w-6 h-6 mr-2" src="https://www.vectorlogo.zone/logos/ko-fi/ko-fi-icon.svg" alt="Buy ko-fi" />
          Buy me a ko-fi
        </a>
        {/* Paypal */}
        <a href="https://www.paypal.me/radondev" className="flex items-center justify-evenly bg-white-500 text-white py-2 px-4 my-2 border border-solid" target="_blank" rel="noreferrer">
          <img className="w-32 h-4" src="https://cdn.worldvectorlogo.com/logos/paypal-2.svg" alt="Donate RadonDev via paypal" />
          {/* <img
        ...
        {/* BuyMeACoffee */}
        <a href="https://www.buymeacoffee.com/" className="flex items-center justify-evenly bg-orange-500 text-white py-2 px-4 my-2" target="_blank" rel="noreferrer">
          <img className="w-6 h-6 mr-2" src="https://www.vectorlogo.zone/logos/buymeacoffee/buymeacoffee-icon.svg" alt="Buy RadonDev A Coffee" />
          Buy me a coffee
        </a>
      </div>
    </div>
