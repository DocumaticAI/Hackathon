  ...
  <div className="bg-gray-100 p-4 flex flex-col justify-center items-center shadow-inner mt-2">
    <div className="w-full flex flex-col sm:flex-row justify-evenly py-2">
      ...
      <div className="text-xl sm:text-base font-light sm:font-normal">
        ...
        <div className="ml-2 sm:ml-0">
          <a href="https://github.com/krypton-hackathon0/hackathon" aria-label="Github krypton-hackathon0/hackathon" target="blank">
            Github
          </a>
        </div>
        <div className="ml-2 sm:ml-0">
          <a href="https://github.com/krypton-hackathon0/hackathon/releases" aria-label="Releases on Github krypton-hackathon0/hackathon" target="blank">
            Releases
          </a>
        </div>
        <div className="ml-2 sm:ml-0">
          <a href="https://github.com/krypton-hackathon0/hackathon/issues" aria-label="Issues in krypton-hackathon0/hackathon" target="blank">
            Issues
          </a>
        </div>
        <div className="ml-2 sm:ml-0">
          <a href="https://github.com/krypton-hackathon0/hackathon/pulls" aria-label="Pull Requests in krypton-hackathon0/hackathon" target="blank">
            Pull Requests
          </a>
        </div>
      </div>
      <div>
        ...
        <div className="ml-2 sm:ml-0">
          <a href="https://dsc.gg/radondev" aria-label="Discord of the community" target="blank">
